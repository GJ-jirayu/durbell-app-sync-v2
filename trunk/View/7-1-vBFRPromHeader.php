...
<div class="alert alert-warning" role="alert" >
    <h4>Setup Bundle Free Item Promotion</h4>
</div>
<div class="row">
    <div class="col-md-12">
        <div class="well">
                ...
                <table >
                    <tr>
                        ...
                        <td colspan="2">
                            ...
                            <div class="row">
                                <div class="col-md-5">
                                    <input type="text"  class="form-control input-sm" size="5" maxlength="10" name="PromNo" id="PromNo"/>
                                </div>
                            </div>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input type="text" class="form-control input-sm" name="PromDesc" maxlength="30" id="PromDesc"/>
                        </td>
...
<div class="row">
    <div class="col-md-12">
        <div class="well">
            <div class="alert alert-warning" role="alert">
                <Strong> List of Bundle Free Promotion</Strong>
            </div>
...
<div class="modal fade bs-addFreeItem-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel2" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="myLargeModalLabel">Setup Bundle Free Item Promotion - Free Item</h4>
            </div>
            <!--
    <div class="bs-callout bs-callout-info">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table >
                                            ...
                                            <tr>
                                                <td>Step</td>
                                                <td><input type="text" class="textNumber" name="freeStep" id="freeStep" maxlength="1" size="3"></td>
                                            </tr>
                                            <tr>
                                                <td> Brand</td>
                                            ...
                                            <tr>
                                                <td>Free Qty</td>
                                                <td >
                                                    <input type="text" class="textNumber" size="20" id="FreeQty" name="FreeQty" value="0">
                                                </td >
                                                <td >Unit </td>
