                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td  colspan="4">
                            ...
                            <input  class="inputData textNumber" type="text" id="Step" name="Step"  size="1" value="<?= $countRows + 1 ?>" readonly="readonly"  style="background:#f5f5f5">	
                    ...
                    <tr>
                        ...
                        <td  colspan="4">
                            ...
                            <textarea  class="inputData" rows="5" cols="50" id="PromStepNote" name="PromStepNote" maxlength="256"></textarea>	
                    ...
                    if ($BreakBy == "Q" or $BreakBy == "LQ") {
                        ...
                        <tr>
                            ...
                            <td>Break Unit Factor</td>
                            <td>
                                <input  class="inputData textNumber" type="text" size="3" id="BreakUnitFactor" name="BreakUnitFactor" value="1" readonly="readonly"  style="background:#f5f5f5" size="3">
                            </td>
                        </tr>
                        <?php
                    } else {
                        ...
                        <tr>
                            <td>Break Amount</td>
                            <td>
                                <input  class="inputData textNumber" type="text"  id="BreakAmt" name="BreakAmt"  value="0" maxlength="13">
                            </td>
                        </tr>
                    ...
                    if ($DiscFor == "P") {
                        ...
                        <tr>
                            ...
                            <td><input  class="inputData textNumber" type="text" name="DiscPer" id="DiscPer"  value="0" maxlength="8"></td>
                        </tr>
                        <?php
                    } else {
                        ?>
                        <tr>
                            <td>Discount Baht</td>
                            <td><input  class="inputData textNumber" type="text" name="DiscBaht" id="DiscBaht"  value="0" maxlength="13"></td>
                        </tr>
                        <?php
                    }
                    ?>
                                    ...
                                    <div class="col-md-12">
                                        <table >
                                            ...
                                            <tr>
                                                <td>Free Qty</td>
                                                <td >
                                                    <input class="textNumber" type="text" size="20" id="FreeQty" name="FreeQty" value="1">
                                                </td >
                                                <td >Unit </td>
                                                <td id="unitCodeArea">
                                                    <!--
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" size="20" id="GLAccount" name="GLAccount" value="">
