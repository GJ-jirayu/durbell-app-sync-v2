            ...
            <div class="well">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input type="text" name="limitFreeQty" id="limitFreeQty" value="0" style="text-align: right; padding-right: 5px"/>
                            Unit 
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input type="text" name="limitDiscBath" id="limitDiscBath" value="0" maxlength="13" style="text-align: right; padding-right: 5px"/>
                        </td>
                    </tr>
