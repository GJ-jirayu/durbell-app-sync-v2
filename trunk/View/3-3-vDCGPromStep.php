                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td  colspan="4">
                            ...
                            <input  class="inputData textNumber" type="text" size="1" id="Step" name="Step" value="<?= $countRows + 1 ?>" readonly="readonly"  style="background:#f5f5f5">	
                    ...
                    if ($BreakBy == "Q" or $BreakBy == "LQ") {
                        ...
                        <tr>
                            ...
                            <td>
                                <input  class="inputData textNumber" type="text" size="3" id="BreakUnitFactor" name="BreakUnitFactor" value="1" readonly="readonly"  style="background:#f5f5f5">
                            </td>
                        </tr>
                        <?php
                    } else {
                    ...
                    if ($DiscFor == "P") {
                        ...
                        <tr>
                            ...
                            <td><input  class="inputData textNumber" type="text" name="DiscPer" id="DiscPer"  value="0"></td>
                        </tr>
                        <?php
                    } else {
                        ?>
                        <tr>
                            <td>Discount Baht</td>
                            <td><input  class="inputData textNumber" type="text" name="DiscBaht" id="DiscBaht" maxlength="13" value="0"></td>
                        </tr>
                        <?php
                    }
                    ?>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myLargeModalLabel">Setup Discount Promotion By Group - Free Item </h4>
            </div>
            <div class="bs-callout bs-callout-info">
                                    ...
                                    <div class="col-md-12">
                                        <table >
                                            ...
                                            <tr>
                                                <td>Free Qty</td>
                                                <td >
                                                    <input type="text" class="textNumber" size="20" id="FreeQty" name="FreeQty" value="1">
                                                </td >
                                                <td >Unit </td>
                                                <td id="unitCodeArea">
                                                    <!--
