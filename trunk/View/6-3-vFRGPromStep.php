...
<div class="alert alert-warning" role="alert" >
    <h4>Setup Free Promotion By Group</h4>
</div>
<!--</div>-->
            ...
            <div class="well">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td  colspan="4">
                            <input  class="inputData" type="hidden" id="Step" name="Step" value="<?= $countRows + 1 ?>" readonly="readonly"  style="background:#f5f5f5">
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    if ($BreakBy == "Q" or $BreakBy == "LQ") {
                        ...
                        <tr>
                            ...
                            <td>Break Quantity Factor</td>
                            <td>
                                <input  class="inputData textNumber" type="text" id="BreakUnitFactor" name="BreakUnitFactor" value="1" size="3" readonly="readonly"  style="background:#f5f5f5">
                            </td>
                        </tr>
                        <?php
                    } else {
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myLargeModalLabel">Setup Free Promotion By Group - Free Item </h4>
            </div>
            <div class="bs-callout bs-callout-info">
                <h4>Promotion Step</h4>
                <div id="detailPromotion">
                    <!-- Display Detail Promotion No -->
                </div>              
            </div>
