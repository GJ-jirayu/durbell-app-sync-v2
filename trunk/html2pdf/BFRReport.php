...
$titleReport = "Setup Bundle Free Item Promotion Report";
...
if (!$rsPromItem) {
    ...
    while (odbc_fetch_row($rsPromItem)) {
        ...
        $htmlData.='<td width="30" style="text-align:left;" >';
        $htmlData.= $Step . '';
        $htmlData.='</td>';
        
        $htmlData.='<td width="80" style="text-align:right;padding-right: 5px;" >';
        $htmlData.=$Break . ' ' . $BreakUnitCode . '';
        $htmlData.='</td>';
        
        $htmlData.='<td width="45" style="text-align:left;" >';
        $htmlData.= $BreakBy . '';
        $htmlData.='</td>';
