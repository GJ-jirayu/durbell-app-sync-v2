...
var searchAutoCompltePromDesc = function(id, defaultText, paramPromType) {
    $.ajax({
        url: "../Model/6-1-mFRGPromHeader.php",
        type: "post",
        dataType: "json",
        sync: false,
...
//                    alert("You Coping Promotion " + data[0] + " to  Promotion " + $("#nPromNo").val());
    ...
    $(".btnAddItem").click(function() {
        ...
        callDCGPromItemFn(id, paramPromType);
    ...
    $(".btnPrint").click(function() {
        ...
        var url = "../html2pdf/FRGResport.php?paramPromNo=" + id + "&paramPromType=" + paramPromType + "";
...
var callDCGPromHeaderFn = function(paramPromType) {

    $.ajax({
        url: "../View/6-1-vFRGPromHeader.php",
        type: "post",
        dataType: "html",
        success: function(data) {
            $("#content").html(data);
            ...
            /*click submit start*/
            $("form#addDiscPromByGroup").submit(function() {
