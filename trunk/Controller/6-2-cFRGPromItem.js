...
var insertDataFn = function(paramPromNo, paramPromType) {
    ...
    $.ajax({
        url: "../Model/6-2-mFRGPromItem.php",
        type: "post",
        dataType: "json",
...
// delete data start
    ...
    $(".btnPromStep").click(function() {
        ...
        //alert(id);
        $(".Controller").remove();
        $("head").append("<script class=\"Controller\" id=\"cDCGPromStep\" type=\"text/javascript\" src=\"../Controller/6-3-cFRGPromStep.js\"></script>");
        ...
        success: function(data) {
            ...
            $("#grid").kendoGrid({
                ...
                columns: [
                    ...
                    {field: "field3", width: '28%'},
                    {field: "field4", width: '%'},
                    {field: "field5", width: '%'},
                    {field: "field6", width: '20%'}
                ]
            });
            setTable();
