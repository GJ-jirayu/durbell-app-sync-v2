...
//        alert(id);
        $(".Controller").remove();
        $("head").append("<script class=\"Controller\" id=\"5-2-cFRIPromItem\" type=\"text/javascript\" src=\"../Controller/5-2-cFRIPromItem.js\"></script>");
    ...
    $(".btnPrint").click(function() {
        ...
        var url = "../html2pdf/FRIReport.php?paramPromNo=" + id + "&paramPromType=" + paramPromType + "";
...
//5-1-cFRIPromItem.js start
var callDiscPromByItemContentFn = function(paramPromType) {

    $.ajax({
        url: "../View/5-1-vFRIPromHeader.php",
        type: "post",
        dataType: "html",
        sync: false,
        success: function(data) {
            ...
            /*click submit start*/
            $("form#addFreePromByItem").submit(function() {
                // check validation start
