...
var countStep = function(paramPromType, paramPromNo) {
    ...
    $.ajax({
        url: "../Model/7-2-mBFRPromStep.php",
        type: "post",
        dataType: "json",
        sync: false,
...
var clearFielddata = function() {
    ...
    $("#PromStepNote").text("");
    $("input#Step").removeAttr('disabled');
    $("#MinimumSKU").val("0");
    $("#Step").val("");
...
var validationFn = function(paramPromNo, paramPromType, paramPromCode, paramPromStepType) {
    ...
    } else if ($("#groupCodeRadio").is(':checked')) {
...
var insertDataFn = function(paramPromNo, paramPromType, paramPromCode, paramPromStepType) {
    ...
    $.ajax({
        ...
        data: {"paramPromNo": paramPromNo, "paramPromType": paramPromType, "paramPromCode": paramPromCode,
            "paramStep": $("#Step").val(), "paramPromStepType": paramPromStepType, "paramMinimumSKU": $("#MinimumSKU").val(),
            ...
            "paramPromStepNote": $("#PromStepNote:visible").val(), "paramAction": $("#paramAction").val()},
        success: function(data) {
            //alert(data);
    ...
    $(".btnEdit").on("click", function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#Step").val("" + data[0] + "");
                $("input#Step").attr('disabled', 'disabled');
//                $("input#Step").val(data[0]).attr({"readonly": "readonly"}).css({"background": "#f5f5f5"});
