            ...
            success: function(data) {
                ...
                setTimeout(function() {
                    $("#unitCode").change(function() {
                        ...
                        calculateUnitFactor($("#FreeQty").val(), $(this).val(), paramPromCode);
                    });
                }, 1000);
...
var insertDataFn = function(paramPromNo, paramPromType, paramPromCode) {
    ...
    $.ajax({
        ...
        sync: false,
        data: {"paramPromNo": paramPromNo, "paramPromType": paramPromType, "paramPromCode": paramPromCode,
            "paramStep": $("#Step").val(), "paramMinimumSKU": 0,
            "paramBreakQty": $("#BreakQty").val(), "paramBreakUnitCode": $("#breakUnitCode").val(),
            "paramBreakUnitFactor": $("#BreakUnitFactor").val(), "paramBreakAmt": $("#BreakAmt").val(),
            "paramDiscPer": $("#DiscPer").val(), "paramDiscBaht": $("#DiscBaht").val(),
            "paramPromStepNote": $("#PromStepNote").val(), "paramAction": $("#paramAction").val()},
        success: function(data) {
            //alert(data);
        ...
        success: function(data) {
            ...
            $("#grid1").kendoGrid({
                ...
                columns: [
                    ...
                    {field: "field4", width: '6%'},
                    {field: "field5", width: '6%'},
                    {field: "field6", width: '8%'},
                    {field: "field7", width: '8%'},
                    {field: "field8", width: '8%'},
            ...
            //sorting start
            setTimeout(function() {
                $("#showAllData table thead th.k-header, .k-pager-wrap, .k-grid-pager, .k-widget").on("click", function() {
                    //START: Set Table
                    setTable();
                    $("table#grid1 tbody tr").each(function() {
                        $("td", this).eq(3).css({"text-align": "right", "padding-rigth": "5px"});
...
var callcPromStepDiscountPromByItemFn = function(paramPromNo, paramPromCode, paramPromType) {
    ...
    $.ajax({
        url: "2-3-vPpromStepDiscountPromByItem.php",
        type: "post",
        data: {"paramPromNo": paramPromNo, "paramPromType": paramPromType, "paramPromCode": paramPromCode},
        dataType: "html",
        sync: false,
        success: function(data) {
            ...
            $("form#addStepDiscountProm").submit(function() {
                ...
                validationFn(paramPromNo, paramPromType, paramPromCode);               // check validation end
