...
var countSeq = function(paramPromType, paramPromNo, paramStep) {
    ...
    $.ajax({
        url: "../Model/4-3-mBDCPromBundleFreeItem.php",
        type: "post",
        dataType: "json",
        sync: false,
...
//    $("#freeStep").val("").removeAttr("readonly").css({"background": "white"});
...
var searchAutoCompltePromDesc = function(id, defaultText, paramPromType) {
    $.ajax({
        url: "../Model/4-1-mBDCPromHeader.php",
        type: "post",
        dataType: "json",
        sync: false,
...
var insertDataFn = function(paramPromType) {
    ...
    $.ajax({
        ...
        data: {"paramPromNo": $("#PromNo").val(), "paramPromDesc": $("#PromDesc").val(),
            ...
            "paramUnitCode": $("select#unitCode").val(),
...
// delete data start
    ...
    $(".btnPrint").on("click", (function() {
        ...
        var id = idPrint[1];
        var url = "../html2pdf/BDCResport.php?paramPromNo=" + id + "&paramPromType=" + paramPromType + "";
    ...
    $(".btnPromStep").click(function() {
        ...
        $(".Controller").remove();
        $("head").append("<script class=\"Controller\" id=\"4-2-cBDCPromStep\" type=\"text/javascript\" src=\"../Controller/4-2-cBDCPromStep.js\"></script>");
...
var callBDCPromHeaderFn = function(paramPromType) {
    ...
    $.ajax({
        url: "../View/4-1-vBDCPromHeader.php",
        type: "post",
        dataType: "html",
        success: function(data) {
            $("#content").html(data);
