...
var countSeq = function(paramPromType, paramPromNo, paramPromCode, paramStep) {
    ...
    $.ajax({
        url: "../Model/6-3-mFRGPromStepFreeItem.php",
        type: "post",
        dataType: "json",
        sync: false,
                ...
                if (data[0] === "id-already") {
                    ...
                    if (confirm('ยืนยันลบข้อมูลใช่ไหม ?')) {
                        $.ajax({
                            ...
                            type: "POST",
                            dataType: "JSON",
                            data: {"paramActionFreeItem": "delete", "paramPromType": paramPromType, "paramPromNo": paramPromNo,
                                "paramPromCode": paramPromCode, "paramStep": paramStep, "paramSeq": getSeq, "paramFreeItemCode": id},
                            success: function(data) {
                                if (data[0] == "success") {
...
var countStep = function(paramPromType, paramPromNo, paramPromCode) {
    ...
    $.ajax({
        url: "../Model/6-3-mFRGPromStep.php",
        type: "post",
        dataType: "json",
        sync: false,
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#back").click(function() {
                ...
                $(".Controller").remove();
                $("head").append("<script class=\"Controller\" id=\"cDCGPromItem\" type=\"text/javascript\" src=\"../Controller/6-2-cFRGPromItem.js\"></script>");
