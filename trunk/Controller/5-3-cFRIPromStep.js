...
var countSeq = function(paramPromType, paramPromNo, paramPromCode, paramStep) {
    ...
    $.ajax({
        url: "../Model/5-3-mFRIPromStepFreeItem.php",
        type: "post",
        dataType: "json",
        sync: false,
...
var insertDataFnAddFreeItem = function(paramPromNo, paramPromType, paramPromCode, paramStep, paramSeq) {
    ...
    $.ajax({
        ...
        data: {"paramPromNo": paramPromNo,
            ...
            "paramStep": paramStep,
            "paramSeq": paramSeq,
            "paramFreeItemCode": $("#itemCode").val(),
            "paramFreeQty": $("#FreeQty").val(),
            "paramFreeUnitCode": $("#unitCode").val(),
            "paramFreeUnitFactor": $("#FreeUnitFactor").val(),
            "paramGLAccount": $("#GLAccount").val(),
...
// delete data start
    ...
    $(".btnFreeItemDel").on("click", function() {
        ...
        var getSeq = $(this).parent().parent().children().eq(0).text();
        var id = idDel[1];
    ...
    $(".btnFreeItemEdit").on("click", function() {
        ...
        $.ajax({
            ...
            data: {"paramActionFreeItem": "edit", "paramPromType": paramPromType, "paramPromNo": paramPromNo,
                "paramPromCode": paramPromCode, "paramStep": paramStep, "paramFreeItemCode": id, "paramSeq": getSeq},
            success: function(data) {
                /*
                 ################       PromStepFreeItem Start ###############
                 paramPromType
                ...
                $("#FreeQty").keyup(function() {
                    ...
                    //alert($("#FreeQty").val());
                    //alert($("#unitCode").val());
                    calculateUnitFactor($("#FreeQty").val(), $("#unitCode").val(), paramPromCode);

                });
                setTimeout(function() {
                    $("#unitCode").change(function() {

                        calculateFreeUnitFactor($("#FreeQty").val(), $(this).val(), paramPromCode);
                    });
                }, 1000);
        ...
        success: function(data) {
            ...
            $("#grid2").kendoGrid({
                ...
                columns: [
                    ...
                    {field: "field2", width: '14%'},
                    {field: "field3", width: '30%'},
                    {field: "field4", width: '%'},
                    {field: "field5", width: '%'},
                    {field: "field6", width: '12%'},
                    {field: "field7", width: '13%'}
                ]
            });
            setTable();
...
var calculateUnitFactor = function(FreeQty, UnitCode, paramPromCode) {
    ...
    $.ajax({
        url: "../Model/5-3-mFRIPromStep.php",
        type: "post",
...
var calculateFreeUnitFactor = function(FreeQty, UnitCode, paramPromCode) {
        ...
        success: function(data) {
            setTimeout(function() {
                ...
                $("#FreeQty").keyup(function() {
                    ...
                    //alert($("#FreeQty").val());
                    //alert($("#unitCode").val());
                    calculateFreeUnitFactor($("#FreeQty").val(), $("#unitCode").val(), $("#itemCode").val());
...
var calculateBreakUnitFactor = function(Qty, UnitCode, paramPromCode) {
    ...
    $.ajax({
        ...
        data: {
            ...
            "paramAction": "getDataUnitFactor"
        },
        dataType: "json",
        sync: false,
        success: function(data) {

            //result = parseInt(Qty) * parseInt(data[0]);

            $("#BreakUnitFactor").val(parseInt(data[0]));
        }
    });
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            $("#grid1").kendoGrid({
                ...
                height: 350,
                columns: [
                    {field: "field1", width: '12%'},
                    {field: "field2", width: '12%'},
                    {field: "field3", width: '27%'},
                    {field: "field4", width: '7%'},
                    {field: "field5", width: ''},
                    {field: "field6", width: ''},
                    {field: "field7", width: '20%'}
                ]
            });
            setTable();
...
//call cPromStepDiscountPromByItemFn.js start
var callcPromStepDiscountPromByItemFn = function(paramPromNo, paramPromCode, paramPromType) {

    $(".embParam").remove();
    $("body").append("<input type=\"hidden\" id=\"embPromNo\" class=\"embParam\" value=" + paramPromNo + ">");

    $.ajax({
        url: "5-3-vFRIPromStep.php",
        type: "post",
        data: {
            "paramPromNo": paramPromNo,
            "paramPromType": paramPromType,
...
//                }
////                calculateBreakUnitFactor(BreakQty, $("#breakUnitCode").val(), paramPromCode);
//
//            });
            ...
            /*click submit Add Promotion Step start*/
            ...
            /*click submit Add Promotion Step end*/

            //back to prodGroupForProm start
            $("#back").click(function() {
                $(".Controller").remove();
                $("head").append("<script class=\"Controller\" id=\"5-1-cAddItemFreeProm\" type=\"text/javascript\" src=\"../Controller/5-2-cFRIPromItem.js\"></script>");
                callAddItemDiscountPromFn($("#embPromNo").val(), paramPromType);
