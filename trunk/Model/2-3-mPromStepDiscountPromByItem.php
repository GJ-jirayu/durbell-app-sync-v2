...
if ($paramAction == "add") {
    ...
    $sqlCheck = "SELECT * FROM PromStep where PromType ='$paramPromType' and  PromNo ='$paramPromNo'and  PromCode ='$paramPromCode' and Step='$paramStep'";
...
if ($paramAction == "edit") {
    ...
    $sql = "SELECT * FROM PromStep where PromType='$paramPromType' and PromNo='$paramPromNo' and PromCode='$paramPromCode' and Step='$paramStep'";
    //$sqlConv=iconv("utf-8", "tis-620", $sql);
    $rs = odbc_exec($conn, $sql);
    if (!$rs) {
        exit("Error in SQL");
...
if ($paramAction == "editAction") {
    ...
    $sql = "UPDATE PromStep SET MinimumSKU='$paramMinimumSKU',BreakQty='$paramBreakQty',BreakUnitCode='$paramBreakUnitCode',
		...
		WHERE PromType='$paramPromType' and PromNo='$paramPromNo' and PromCode='$paramPromCode' and Step='$paramStep'";
...
if ($paramAction == "showData") {
    ...
    $sql = "SELECT PromStep.*,Item.ItemDesc FROM PromStep
left join Item on PromStep.PromCode=Item.ItemCode
where PromType='$paramPromType' and PromNo='$paramPromNo' and PromCode='$paramPromCode' order by PromNo, PromCode, Step";
    ...
    $htmlShowData.= "<th data-field=\"field5\"><b>Break <br> Qty   </b></th>";
    $htmlShowData.= "<th data-field=\"field6\"><b>Break <br> Amt </b></th>";
    $htmlShowData.= "<th data-field=\"field7\"><b>Discount <br> Percent</b></th>";
    $htmlShowData.= "<th data-field=\"field8\"><b>Discount <br> Baht</b></th>";
    $htmlShowData.= "<th data-field=\"field9\"><b>Manage  </b></th>";
    $htmlShowData.="</tr>";
    $htmlShowData.= "</thead>";
    ...
    while (odbc_fetch_row($rs)) {
        ...
        $BreakUnitCode = iconv("tis-620", "utf-8", odbc_result($rs, "BreakUnitCode"));
        $BreakUnitFactor = iconv("tis-620", "utf-8", odbc_result($rs, "BreakUnitFactor"));
        $DiscPer = number_format(iconv("tis-620", "utf-8", odbc_result($rs, "DiscPer")), '2', '.', ',');
        $DiscBaht = number_format(iconv("tis-620", "utf-8", odbc_result($rs, "DiscBaht")), '2', '.', ',');
        ...
        $htmlShowData.= "<td>$DiscPer</td>";
        $htmlShowData.= "<td>$DiscBaht</td>";
        $htmlShowData.="
							<td>
