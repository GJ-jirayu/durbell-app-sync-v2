...
if ($paramAction == "checkUseProm") {
    $sqlCheck = "SELECT * FROM OrderDetailGetPromotion  where PromType ='$paramPromType'and  PromNo ='$paramPromNo' and PromCode='$paramPromCode' and Step='$paramStep'";
    if (checkAlreadyId($conn, $sqlCheck) == "Already-Id") {
        echo'["id-already"]';
    } else {
        echo'["id-empty"]';
...
if ($paramAction == "showData") {
    ...
    $sql = "SELECT PromStep.*,PromGroup.GroupDesc FROM PromStep
left join PromGroup on PromStep.PromCode=PromGroup.GroupCode
where PromType='$paramPromType' and PromNo='$paramPromNo' and PromCode='$paramPromCode'";
