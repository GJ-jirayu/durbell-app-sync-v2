...
left join Item on PromStep.PromCode=Item.ItemCode where PromType='$paramPromType' and PromNo='$paramPromNo' and PromCode='$paramPromCode' and Step='$paramStep'";
...
//add data
if ($paramAction == "add") {
//    $itemNo = count($paramFreeItemCode);
//    $res = array();
//    for ($i = 0; $i < $itemNo; $i++) {
        $sqlCheck = "SELECT * FROM PromStepFreeItem where PromType ='$paramPromType' and  PromNo ='$paramPromNo'and  PromCode ='$paramFreeItemCode' AND Step='$paramStep' AND FreeItemCode='$paramPromCode' and Seq='$paramSeq'";
...
where PromType='$paramPromType' and PromNo='$paramPromNo' and PromCode='$paramPromCode' and Step='$paramStep' order by Seq";
