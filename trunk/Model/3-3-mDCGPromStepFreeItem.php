...
where PromType ='$paramPromType' and  PromNo ='$paramPromNo'and  PromCode ='$paramFreeItemCode' AND Step='$paramStep' AND FreeItemCode='$paramPromCode'";
...
if ($paramAction == "showData") {
    ...
    $sql = "SELECT psft.*,Item.ItemDesc,Unit.UnitName FROM PromStepFreeItem psft
...
";
    ...
    while (odbc_fetch_row($rs)) {
        ...
        $htmlShowData.= "<tr>";
        $htmlShowData.= "<td data-field=\"field1\" >$Seq</td>";
        $htmlShowData.= "<td data-field=\"field2\" >$FreeItemCode</td>";
        $htmlShowData.= "<td data-field=\"field3\" >$Description</td>";
        $htmlShowData.= "<td data-field=\"field4\" >$FreeQty</td>";
        $htmlShowData.= "<td data-field=\"field5\" >$UnitName</td>";
        $htmlShowData.= "<td data-field=\"field6\" >$GLAccount</td>";
        $htmlShowData.="
			<td data-field=\"field7\" >
