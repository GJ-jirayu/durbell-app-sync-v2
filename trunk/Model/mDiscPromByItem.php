...
if ($paramAction == "edit") {
    ...
    $sql = "SELECT * FROM PromHeader where PromNo ='$paramPromNo' and PromType='$paramPromType' order by PromNo";
    $rs = odbc_exec($conn, $sql);
    if (!$rs) {
        exit("Error in SQL");
    } else {
...
//        echo"[\"$PromNo\",\"$PromDesc\",\"$StartDate\",\"$EndDate\",\"$Priority\",[$BranchCode],[$ShopTypeCode],[$SalesTeam]]";
...
if ($paramAction == "editAction") {
    ...
    $sql = "UPDATE PromHeader SET PromDesc='$paramPromDesc',StartDate='$paramStartDate',EndDate='$paramEndDate',Priority='$paramPriority',last_modified='$last_modified' WHERE PromNo='$paramPromNo'";
...
if ($paramAction == "showData") {
    ...
    $htmlShowData.= "<col />";
    $htmlShowData.= "<col />";
    $htmlShowData.= "<col style=\"width:26%\" />";
    $htmlShowData.= "</colgroup>";
